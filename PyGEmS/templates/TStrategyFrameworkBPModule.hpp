...
#ifndef __PYGEMS_TSTRATEGYFRAMEWORKBPMODULE__
#define __PYGEMS_TSTRATEGYFRAMEWORKBPMODULE__

#include "TContainer.h"
#include "TStrategy.h"
#include "PyTStrategy.h"
#include "Utils.hpp"
...
namespace NSPyGEmS
{
  //Expose these types to python: BOOST_PYTHON_MODULE to define a python module containing all these types
  //This is the module tha python see (ours)
  BOOST_PYTHON_MODULE ( TStrFramework )
  {
    ...
    //Expose the classes !!!
    bp::class_<TContainer<StrategyParams>>( "TContainer", bp::no_init );

    bp::class_<PyTStrategy<StrategyParams>, boost::noncopyable>( "TStrategy", bp::no_init
    )//.def( "sendParamaterToCppApplication", &TStrategy::receivingParameterFromPython )
            ;

    bp::class_<std::vector<StrategyParams> >( "TPyGEmSVec" )
